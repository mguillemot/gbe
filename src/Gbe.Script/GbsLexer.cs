...

{
    ...
    public class GbsLexer : Lexer
    {
        ...
        private static readonly short[][] DFA1_transition = DFA.UnpackEncodedStringArray(DFA1_transitionS);
        ...
        protected class DFA1 : DFA
        {
            ...
            public override string Description
            {
                ...
                {
                    return
                        "147:1: COLOR : ( 'black' | 'white' | 'red' | 'green' | 'blue' | 'yellow' | 'pink' | 'lightblue' | '#' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT );";
                }
            }
        }
        ...
        protected class DFA16 : DFA
        {
            ...
            public override string Description
            {
                ...
                {
                    return
                        "1:1: Tokens : ( T__47 | T__48 | T__49 | T__50 | T__51 | T__52 | THIS | ENTITY_ENGINE | ENTITY_PLAYER | ENTITY_BULLET | ENTITY_ENEMY | ENTITY_SCRIPT | ENTITY_STATE | ENTITY_EVENT | PARAM_FPS | PARAM_GAMEAREA | PARAM_POSITION | PARAM_COLOR | PARAM_SPEED | PARAM_ANIMATION | PARAM_SCROLLING | ACTION_PERIODIC | ACTION_FIRE_AT_PLAYER | ACTION_DIE | ACTION_START | ACTION_STOP | ACTION_SUMMON | ACTION_PLAY_ANIMATION | ACTION_SET | TRIGGER_INIT | TRIGGER_CLEANUP | TRIGGER_TIME | TRIGGER_SCROLLING | TRIGGER_ANIMATION_END | TRIGGER_EVENT | COLOR | DIRECTION | NUMBER | POINT | RECTANGLE | CLASS_IDENTIFIER | INSTANCE_IDENTIFIER | STRING | WHITESPACE | ML_COMMENT | SL_COMMENT );";
                }
            }
        }
